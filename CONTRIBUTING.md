...
5.  From your branch, make a pull request against `DSACMS/pra-guides/main`
6.  Work with repo maintainers to get your change reviewed
7.  Wait for your change to be pulled into `DSACMS/pra-guides/main`
...
pra-guides will see regular updates and new releases. This section describes the general guidelines around how and when a new release is cut.
...
pra-guides uses [Semantic Versioning](https://semver.org/). Each release is associated with a [`git tag`](github.com/DSACMS/pra-guides/tags) of the form `X.Y.Z`.
...
The following steps outline the process to prepare a Release Candidate of pra-guides. This process makes public the intention and contents of an upcoming release, while allowing work on the next release to continue as usual in `dev`.
...
The following steps describe how to make an approved [Release Candidate](#preparing-a-release-candidate) an official release of pra-guides:
...
[proj-releases-new]: https://github.com/DSACMS/pra-guides/releases/new
-->
...
docs. Please file an [issue](https://github.com/DSACMS/pra-guides/issues).
-->
